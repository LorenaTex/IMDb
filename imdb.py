...
Original file is located at
    https://colab.research.google.com/drive/1qVLwoaKB7KNesypxjYUOYbF2l8NyY7a7
"""
  ...
  for container in movie_containers:
      if container.find ('div', class_ =' ratings-metascore') is not None:
        ...
        if container.p.find('span', class_ = 'genre') is not None:
          genre = container.p.find('span', class_ = 'genre').text.replaced("\n", "".rstrip().split(','))
          #pular linha e colocar mais de um genero de cada filme
          genres.append(genre)
        else:
          genres.append("")
        ...
        if container.p.find('span', class_ = 'runtime') is not None:
          time = int(container.p.find('span', class_ = 'runtime').text.replaced('min', ""))
          runtimes.append(time)
        else:
          runtimes.append(None)

        #captura avaliacao do imdb, converte em decimal p realizar calculo
...
#distribui os dados em suas respectivas colunas de ano, tratando os anos p que sejam valores numericos
